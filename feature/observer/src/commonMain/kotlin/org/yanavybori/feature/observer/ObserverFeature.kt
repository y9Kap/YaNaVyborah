...
fun ObserverFeature(
    ...
    val viewModel: ObserverViewModel = viewModel { ObserverViewModel(dependencies) }
    ...
    Scaffold(
        ...
        bottomBar = {
            if (!LocalPlatformUi.current.isKeyboardVisible()) CompactCounterBar(
...
internal fun formatTimestamp(timestamp: Long): String =
    org.yanavybori.core.common.formatLocalTimestamp(timestamp)
