...
object SystemClock : Clock { override fun now(): Long = kotlin.time.Clock.System.now().toEpochMilliseconds() }

object UuidGenerator : IdGenerator { override fun newId(): String = Uuid.random().toString() }
...
object CounterPolicy {
    fun increment(currentValue: Long, delta: Int = 1): Long {
        ...
        if (currentValue > Long.MAX_VALUE - delta) throw ArithmeticException("long overflow")
