    ...
    if (opened && !fullGuide) AlertDialog(
        ...
        text = {
            Column(Modifier.verticalScroll(rememberScrollState()), verticalArrangement = Arrangement.spacedBy(10.dp)) {
                ...
                Text("Документы доступны офлайн. В «Избирателе» поиск запускается кнопкой и может сравнивать несколько списков. Записи сохраняются на устройстве; приложение ничего не отправляет автоматически.")
            }
        },
